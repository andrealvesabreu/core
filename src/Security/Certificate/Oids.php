...
class Oids
{
     ...
     * @var array|null
     */
    private static ?array $oidsTable = [
        ...
        '2.16.76.1.2.3.20' => 'Política de Certificado de Assinatura Tipo A3da Autoridade Certificadora PRODEMGE SRF',
        ...
        '2.16.76.1.2.201.5' => 'PC da Autoridade Certificadora do SistemaJustiça Federal - AC­ JUS',
        '2.16.76.1.2.201.6' => 'PC da Autoridade Certificadora do SERPRO (AC SERPRO)',
        '2.16.76.1.2.201.7' => 'PC da Autoridade Certificadora ImprensaOficial SP (AC IMESP)',
        '2.16.76.1.3' => 'Atributos Obrigatórios de Certificados',
        '2.16.76.1.3.1' => 'dados do titular (data de nascimento, etc.) pessoa física',
        '2.16.76.1.3.2' => 'nome do responsavel pessoa jurídica',
        '2.16.76.1.3.3' => 'Cadastro Nacional de Pessoa Jurídica (CNPJ)',
        '2.16.76.1.3.4' => 'dados do responsavel pessoa jurídica',
        '2.16.76.1.3.5' => 'Titulo de Eleitor do titular',
        '2.16.76.1.3.6' => 'Cadastro Especifico do INSS (CEI) pessoa física',
        '2.16.76.1.3.7' => 'Cadastro Específico do INSS (CEI) pessoa jurídica',
     ...
     *
     * @param string $key
     *            formated OID numeric key
     * @return string|null
     */
    public static function getOid(string $key): ?string
    {
        self::loadOids();
        if (is_array(self::$oidsTable) && Arrays::exists(self::$oidsTable, $key)) {
